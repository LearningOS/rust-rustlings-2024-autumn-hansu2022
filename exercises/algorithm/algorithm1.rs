...
impl<T:Ord+Clone> LinkedList<T> {
	...
	pub fn merge(list_a:LinkedList<T>,list_b:LinkedList<T>) -> Self
	{
        ...
        //Traverse both lists and add the smaller node to the result list
        while current_a.is_some() && current_b.is_some(){
            ...
            if a_val < b_val{
                ...
                current_a = unsafe {unsafe { (*current_a.unwrap().as_ptr()).next}};

            }else{
                result.add(b_val.clone());
                current_b = unsafe {unsafe { (*current_b.unwrap().as_ptr()).next}};
            }
        }
        //if there are any remaining nodes in list_a, add them to the result list
        ...
        //if there are any remaining nodes in list_b, add them to the result list
